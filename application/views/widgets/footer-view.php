...
<footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Rekam Medik 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Anda logout?</h5>
  ...
  <!-- Merefresh div dengan id messageCount setiap 3 detik untuk mengupdate pesan masuk -->
  <script>
    ...
    function checkExpired(){
      var httpRequest = new XMLHttpRequest();
        httpRequest.open("GET", "<?= base_url('pesan/expiredMessage'); ?>", true);
        httpRequest.send();
    }
  </script>
</body>
