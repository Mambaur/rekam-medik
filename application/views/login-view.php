...
<head>
  ...
  <title>SI Rekam Medik - Login</title>
                ...
                <div class="p-5">
                  ...
                  <form action="<?= base_url();?>auth/login" method="post" class="user">
                    <div class="form-group">
                      <input type="text" name="email" class="form-control form-control-user" value="<?= set_value('email'); ?>" placeholder="Masukkan email anda..." required>
                    </div>
                    <div class="form-group">
                      <input type="password" name="password" class="form-control form-control-user" id="exampleInputPassword" value="<?= set_value('password'); ?>" placeholder="Masukkan password anda..." required>
                    </div>
